        ...
        <div className="border-t border-white/15">
          {intents.map(({ label, detail, category, query, icon: Icon, color }, index) => (
            <button
              ...
              className="group relative flex w-full items-center gap-4 overflow-hidden border-b border-white/15 py-5 text-left transition-all duration-300 sm:gap-7 sm:py-7"
            >
              ...
              <span className="relative z-10 grid size-11 shrink-0 place-items-center rounded-full border border-white/15 transition-all duration-300 group-hover:rotate-[-10deg] group-hover:scale-110 group-hover:border-black/20 group-hover:text-black">
                <Icon className="size-4" />
              </span>
              <span className="relative z-10 min-w-0 flex-1 text-[clamp(1.55rem,4.5vw,4.8rem)] font-black leading-none tracking-[-.06em] transition-all duration-300 group-hover:translate-x-2 group-hover:text-black">
                {label}
              </span>
              ...
              <ArrowDownRight className="relative z-10 size-6 shrink-0 text-white/30 transition-all duration-300 group-hover:-rotate-45 group-hover:scale-110 group-hover:text-black sm:size-9" strokeWidth={1.5} />
            </button>
          ))}
        </div>
      </div>
